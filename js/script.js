...
// Question 3
/* Use the style property on the heading variable 
from the question above to change its font size to "2em */
...
resultsContainer and 
set its inner HTML to be <p>New paragraph</p> and its 
...
/* Create a function called createCats. The function will have one 
parameter called cats. :)

Inside the function loop through the value passed in as cats and create 
HTML for each object in the array. :)
